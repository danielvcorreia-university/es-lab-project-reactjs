...
class LineChartFaro extends React.Component {
    ...
    componentDidMount() {
        WeatherService.get_temp_history_faro().then((response) => {
        ...
        return (
            ...
            <div>
                ...
                data={{
                    ...
                    datasets: [{
                        label: "Histórico de Temperaturas em Faro",
